...
object MessageService {
    ...
    fun getChannels (context: Context, complete: (Boolean) -> Unit){                                //request from API to GET all created channels, returns an array of JSONObject's
        val channelsRequest = object : JsonArrayRequest (Method.GET, URL_GET_CHANNELS, null, Response.Listener {response ->
            ...
            override fun getHeaders(): MutableMap<String, String> {                                 //ta funkcja wysyla header do API w postaci Mapy<Key, Value>
                ...
                headers.put("Authorization", "Bearer ${AuthService.authToken}")                                   //nazewnictwo z header'a naszej API
                return headers
            }
        }
